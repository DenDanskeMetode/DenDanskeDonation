...
function SocialAuthButtons({ btnClassName = 'login-btn-social' }) {
  return (
    <>
      <button className={btnClassName} onClick={() => { window.location.href = `${BACKEND_URL}/auth/google`; }}>
      ...
      <button className={btnClassName} onClick={() => { window.location.href = `${BACKEND_URL}/auth/facebook`; }}>
