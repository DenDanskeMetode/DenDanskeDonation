...
function SocialAuthButtons({ btnClassName = 'login-btn-social' }) {
  ...
  return (
    <>
      <button className={btnClassName} onClick={() => handleOAuth('google')} disabled={redirecting}>
      ...
      <button className={btnClassName} onClick={() => handleOAuth('facebook')} disabled={redirecting}>
